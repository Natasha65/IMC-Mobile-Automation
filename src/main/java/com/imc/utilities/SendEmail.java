...
public class SendEmail {
	...
	final static String password = "planigwazolcgimc";
	...
	public static void SendEmailNow(String body) {
	        ...
	        try {
	            ...
	            message.setRecipients(Message.RecipientType.TO,
	            		InternetAddress.parse("natasha.javed@supersoft.com.pk")
	            		);
	            String currentDateTime = new SimpleDateFormat("dd-MMM-yyyy_h:mm a z").format(Calendar.getInstance().getTime());
	            message.setSubject("IMC Automation Tests Run Report on "+currentDateTime);
